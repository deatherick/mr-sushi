...
public class SettingsActivity extends AppCompatPreferenceActivity {
            ...
            if (preference instanceof ListPreference) {
                ...
                preference.setSummary(
                        index >= 0
                                ...
                                : null);
                if(listPreference.getEntries()[index] != null){
                    // We need an Editor object to make preference changes.
                    // All objects are from android.context.Context
                    String listvalue = listPreference.getEntryValues()[index].toString();
                    editor.putString("location", listvalue);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ListPreference list = (ListPreference) root.findPreference("location_list");
            ArrayList<Location> locations = mDbHelper.getAllLocations();
            CharSequence entries[] = new String[locations.size()];
            CharSequence entryValues[] = new String[locations.size()];
            int i = 0;
